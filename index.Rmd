...
To make suggestions and changes see the Github repo: [Vitamin_d\_covid](https://github.com/GShotwell/vitamin_d_covid/blob/master/index.Rmd). For more on vitamin D and Covid, see [my blog](https://shotwell.ca/). Note that as of fall 2021, I am no longer tracking retrospective studies unless they have are able to reach novel conclusions.
