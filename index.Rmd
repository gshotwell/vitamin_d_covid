...
-   A [ward-randomized trial](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=3771318) of 930 people found that wards which provided calcifediol supplementation had a 60% lower mortality than wards that did not. Note that the data was analyzed as though it were patient-randomized, which may not be the appropriate statistical methodology depending on how patients were allocated to wards. (Nogues et al, February 2021)
